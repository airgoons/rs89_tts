...
namespace SteamCloudFileManager
{
    public class RemoteStorage : IRemoteStorage, IDisposable
    {
        ...
        public RemoteStorage(uint appID)
        {
        ...
        {
            checkDisposed();
            return new RemoteFile(this, name); // retain case sensitivity vs. SteamCloudFileManager behavior [old call:  name.ToLowerInvariant()]
        }
